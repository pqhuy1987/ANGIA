(function($){
    ...
    $('document').ready(function()
    {
        ...
        $(".widget-overlay .close").on('click', function(){
            $(".widget-overlay").fadeOut();
        });

        $(".addwidgetconfirm").on('click', function(){
        ...
        $(".sidebarwidget").on('click', function(){
        ...
        if ( $(".linkedin-oauth-code-enable").length )
        {
            ...
            $(".linkedin-oauth-code input").on('click', function(e){
                e.preventDefault();
        ...
        window.widget_script = function(wrapper)
        {
            ...
            $(container).find('.type-slider').each(function()
            {
                ...
                $(this).find('.jnews-slider-reset').on('click', function()
                {
