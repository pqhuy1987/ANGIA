...
if(JNews\Footer\FooterBuilder::getInstance()->is_on_footer())
{
    ...
    if($footer_widget_title_color) {
        $footer_style .= " .jeg_footer .{$footer_class} .widget h2, .jeg_footer .{$footer_class}.footer_light .jeg_footer_heading h3, .{$footer_class}.footer_dark .jeg_footer_heading h3 { color : {$footer_widget_title_color}; }";
    }
