...
(function ($) {
    ...
    if (sidecontent_wrapper.length) {
      ...
      var calculate_sidebar_size = function () {
        ...
        if ($(window).width() > 1024) {
          ...
          sidecontent_wrapper.css('height', $(window).height() - $('.jeg_side_heading').outerHeight() -
            $('.jeg_navbar_mobile_wrapper').outerHeight())
        }
  ...
  function sidecontent () {
    ...
    if (sidecontent.length) {
      ...
      var stickybar = $('.jeg_stickybar')
      var top = 0
      var st = 0
      var transformMatrix, matrix, transY
      ...
      var do_sticky_sidebar = function () {
        ...
        if(stickybar.length) {
          transformMatrix = stickybar.css("-webkit-transform") ||
                            stickybar.css("-moz-transform")    ||
                            stickybar.css("-ms-transform")     ||
                            stickybar.css("-o-transform")      ||
                            stickybar.css("transform")
        ...
        if (st > offset_top) {
          ...
          if ($('.jeg_header').hasClass('full') && transY > 0 && stickybar.length) {
            top = top + stickybar.outerHeight()
          }          
        } else {
  ...
  $.fn.jtabs = function () {
    $(this).each(function () {
      ...
      $('.jeg_tabpost_nav li', ele).on('click', function () {
  ...
  $.fn.jnews_slider = function () {
    $(this).each(function () {
      ...
      $(element).find('.jeg_slider_type_2').each(function () {
        var element = $(this).addClass('owl-carousel')
        var autoplay = $(element).data('autoplay')
        var delay = $(element).data('delay')

        $(element).on('initialized.owl.carousel', function () {
          element.siblings('.jeg_slider_placeholder').remove()
          element.parent().addClass('jeg_slider_wrapper_loaded')
        }).owlCarousel({
          rtl: jnewsoption.rtl == 1,
          nav: false,
          items: 1,
...
(function ($) {
  ...
  window.jnews.menu = {
    ...
    search_toggle: function ($container) {
      $container.find('.jeg_search_toggle').on('click', function (e) {
        e.preventDefault()
    ...
    live_search: function ($container) {
      ...
      $container.find('.search-all-button').on('click', function (e) {
        e.preventDefault()
        var parent = $(this).parents('.jeg_search_wrapper')
    ...
    attach_mouseenter_subcategory: function (ele, menu) {
      $(ele).find('.jeg_newsfeed_subcat li').on('mouseenter', function () {
  ...
  window.jnews.mobile =
    {
      ...
      truncate: function () {
        $('.content-inner.mobile-truncate').on('click', function () {
      ...
      menu: function () {
        ...
        $('.jeg_mobile_toggle').unbind('click', element.show_menu).on('click', element.show_menu)
        $('.jeg_menu_close').unbind('click', element.hide_menu).on('click', element.hide_menu)
      ...
      search: function () {
        // Mobile Search
        $('.jeg_mobile_search').on('click', function (e) {
          e.preventDefault()
  ...
  window.jnews.share =
    {
      init: function ($container) {
        ...
        $container.find('.jeg_sharelist a, .jeg_post_share a').unbind('click.share').bind('click.share', function (e) {
          ...
          if (!element.hasClass('jeg_btn-email') && !element.hasClass('jeg_btn-whatsapp') &&
            !element.hasClass('jeg_btn-line')) {
            e.preventDefault()
  ...
  window.jnews.widget.popular =
    {
      init: function ($container) {
        ...
        $container.find('.widget_jnews_popular .socialshare_list a').on('click', function (e) {
          var element = $(this)
          e.preventDefault()
          var url = element.attr('href')
          window.open(url, '', 'height=570,width=750')
  ...
  window.jnews.popup =
    {
      ...
      popup_photoswipe: function () {
        ...
        $(base.container).find('.jeg_featured.featured_image a').on('click', function (e) {
          e.preventDefault()
          base.expand_single_featured(this)
        })

        // featured image gallery
        $(base.container).find('.featured_gallery a').on('click', function (e) {
          e.preventDefault()
  ...
  window.jnews.popuppost =
    {
      ...
      init: function ($container) {
        ...
        if (base.element.length > 0) {
          ...
          base.element.find('.jeg_popup_close').on('click', function (e) {
            e.preventDefault()

            base.element.removeClass('active').addClass('closed')
          })
  ...
  window.jnews.sidefeed =
    {
      ...
      bind_load_button: function () {
        ...
        base.loadbutton.on('click', function (e) {
          e.preventDefault()
  ...
  window.jnews.comment =
    {
      ...
      init: function ($container) {
        ...
        $(base.container).find('.ajax_comment_button').on('click', function () {
  ...
  window.jnews.zoom =
    {
      ...
      setSizeContent: function (zoomLevel) {
        ...
        var wrapperWidth = (base.container.find('.jeg_inner_content').width() === null) ? base.container.find(
          '.jeg_custom_content_wrapper').width() : base.container.find('.jeg_inner_content').width()
      ...
      updateZoom: function (zoom) {
        ...
        base.zoomLevel = (base.zoomLevel > (1 + (base.zoomInStep / 10)))
          ? (1 + (base.zoomInStep / 10))
          : base.zoomLevel
      ...
      zoomEvent: function () {
        ...
        base.zoomOut.on('click', function () { base.updateZoom(-0.1) })
        base.zoomIn.on('click', function () { base.updateZoom(0.1) })
        base.zoomReset.on('click', function () { base.resetZoom() })
  ...
  window.jnews.ajax_analytic =
    {
      ...
      google_analytics: function (track_page_url) {
        if (typeof pageTracker === 'undefined' && typeof _gaq === 'undefined' && typeof ga === 'undefined' &&
          typeof __gaTracker === 'undefined' && typeof gaplusu === 'undefined') {
          return
        }
  ...
  window.jnews.menu_drop = {
    init: function () {
      var base = this
      base.menu_drop = $('.menu-item-has-children')
      if ($(window).width() <= 1024) {
        this.disableUrl()
        this.newEvent()
      }
    ...
    disableUrl: function () {
      ...
      base.menu_drop.find('.sf-with-ul').on('click', function (e) {
        e.preventDefault()
      })
    },
    newEvent: function () {
      var base = this
      base.menu_drop.on('click', function () {
