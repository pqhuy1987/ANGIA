(function (api, $) {
  ...
  function open_setting() {
    $("[data-section^=jnews]").on('click', function () {
      go_to_section(this);
    });

    $("[data-control^=jnews]").on('click', function () {
      go_to_control(this);
    });
  }
  ...
  function align_click() {
    $(".header-column-option-align li").on('click', function (e) {
  ...
  function display_click() {
    $(".header-column-option-display li").on('click', function (e) {
      if (!$(this).hasClass('active')) {
        var selector = find_row_column(this);
  ...
  function element_close_clicked() {
    $(".header-element-close").on('click', function () {
  ...
  function header_setting() {
    $(".header-setting").on('mousedown', function () {
      var element = $(this);
  ...
  function header_builder_button() {
    ...
    $(".jeg-btn-header-builder").on('click', function () {
  ...
  function dispatch() {
    ...
    $('.header-builder-open').on('click', open_header_builder);
