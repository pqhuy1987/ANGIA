...
(function ($) {
    ...
    {
        show_hide_review();
        $("input[name='jnews_single_review[enable_review]']").on('click', function(){
            show_hide_review();
        });
    }
    ...
    function page_metabox()
    {
        ...
        if ( $('body').hasClass('gutenberg-editor-page') || $page_template.length < 1 ) {
            $('option[value="template-builder.php"]').parent().on('change', page_metabox_visibililty);
        } else {
            $page_template.on('change', page_metabox_visibililty);
        }
    }
    ...
    function do_ajax_install_plugin()
    {
        ...
        $('.jnews-plugin-item .jnews-item-button > .button').on('click', function(e)
        {
            e.preventDefault();
    ...
    window.jnews.import = {
        ...
        bind_event : function()
        {
            this.$btn_import.on('click', this.import_install.bind(this));
            this.$btn_uninstall.on('click', this.import_uninstall.bind(this));
        },
    ...
    function do_documentation_plugin()
    {
        if ( $(".jnews-video-documentation").length )
        {
            ...
            $(".video-wrapper .video-item").on('click', function(e){
                e.preventDefault();
