( function(  $ ) {
    ...
    {
        $('.video-documentation').on('click', function(){
            $('body').addClass('video-documentation-body');
            load_player();
            video_resize();
        });

        $('.video-documentation-close, .video-documentation-overlay').on('click', function(){
            $('body').removeClass('video-documentation-body');
            stop_video();
        });

        $(".video-documentation-list a").on('click', function(e){
            e.preventDefault();
            var id = $(this).data('id');
